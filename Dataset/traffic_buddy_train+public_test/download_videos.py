...
if __name__ == "__main__":
    ...
    download_video_in_file(saved_dir=saved_dir, json_file="E:/AI Competition/Zalo AIC/RoadBuddy Understanding the Road through Dashcam AI/traffic_buddy_train+public_test/traffic_buddy_train+public_test/public_test/public_test.json")
    download_video_in_file(saved_dir=saved_dir, json_file="E:/AI Competition\Zalo AIC\RoadBuddy Understanding the Road through Dashcam AI/traffic_buddy_train+public_test/traffic_buddy_train+public_test/train/train.json")